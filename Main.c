...
// Bring in the types & function signatures from HashFunctions.c
...
// This is the function you pasted into HashFunctions.c
...
int main(void) {
    ...
    // 3) run PRINT (with a log file; pass NULL instead of logf to disable)
